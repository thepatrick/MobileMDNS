...
@synthesize domainViewController, api, domains;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	cell.textLabel.text = [[domains objectAtIndex:indexPath.row] objectForKey:@"fqdn"];
    // Configure the cell...
...
//		}
//		self.domainViewController.detailItem = [domains objectAtIndex:indexPath.row];
//		[self.navigationController pushViewController:self.domainViewController animated:YES];
	}
}
